    ...
    return (
        <Fragment>
            ...
            id="domu">
                ...
                decoding="async"
                draggable={false}
                className="w-full min-h-[950px] md:min-h-[750px] md:h-[100vh] object-cover"
                // min-h-[800px]
                />
                <Wrapper className="p-2 md:p-3 lg:p-4 absolute inset-0 flex justify-start items-center flex-col gap-4 md:gap-6 lg:gap-8 text-white text-center rounded-md">
                    <Wrapper className="mt-[70px] md:mt-[100px] p-2 md:p-3 lg:p-4 bg-black/50 flex justify-center items-center flex-col gap-4 md:gap-6 lg:gap-8 rounded-md">
                    ...
                    <Wrapper className="p-4 md:p-5 lg:p-6 flex justify-center items-center flex-col md:flex-row gap-4 md:gap-6 lg:gap-8 w-full">
                        ...
                        <NoProofLink
                        href="kontakt"
                        className="p-4 md:p-5 lg:p-6 bg-[#a11106] text-white text-base md:text-[17px] lg:text-lg font-medium text-center w-full md:w-75 rounded-md"
                        onClick={(e) => {
