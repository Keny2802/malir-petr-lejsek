    ...
    return (
        <Fragment>
            ...
            id="domu">
                ...
                decoding="async"
                draggable={false}
                className="w-full min-h-[850px] md:min-h-[850px] md:h-[100vh] object-cover"
                // min-h-[800px]
                />
                <Wrapper className="p-2 md:p-3 lg:p-4 absolute inset-0 flex justify-start items-center flex-col gap-4 md:gap-6 lg:gap-8 text-white text-center rounded-md">
                    <Wrapper className="mt-[30px] md:mt-[25px] p-2 md:p-3 lg:p-4 bg-black/50 flex justify-center items-center flex-col gap-4 md:gap-6 lg:gap-8 rounded-md">
