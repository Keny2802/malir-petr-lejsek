...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Malování dětského pokoje | Profi Malby Petr Lejska",
    description: "Hledáte spolehlivého malíře bytů v Brně? Zajistíme profesionální výmalbu bez starostí.",
    url: "https://www.profimaby.cz/vice/malovani-detskeho-pokoje",
    ...
    images: [
      {
        url: "/Fotky/Clean Logo.png",
        alt: "Malování dětského pokoje - Profi Malby Petr Lejska",
        type: "image/png",
        width: 1200,
        height: 630,
      }
